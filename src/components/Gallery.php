...
class Gallery extends Widget
{
    ...
    public function run()
    {
        ...
        echo '<div id="' . $this->id . '"><table class="table table-striped table-hover table-border"><thead></thead><tbody>';
    ...
    {
        if (is_string($item)) {
            return Html::tag('tr',Html::tag('td',Html::a(Html::img($item), $item, ['class' => 'gallery-item'])));
        }
        ...
        if($type=='text/html'){
            return Html::tag('tr',Html::tag('td',Html::a($src,$url,$options)));
        }

        return Html::tag('tr',Html::tag('td',Html::a(Html::img($src, $imageOptions), $url, $options)));
    }
